...
func (*GetMyCatMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_cat_a9b6d1bc7547023a, []int{0}
}
...
func (*MyCatResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_cat_a9b6d1bc7547023a, []int{1}
}
...
func init() { proto.RegisterFile("cat/cat.proto", fileDescriptor_cat_a9b6d1bc7547023a) }

var fileDescriptor_cat_a9b6d1bc7547023a = []byte{
